...
class _RegisterScreenState extends State<RegisterScreen>
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      // Use email prefix as default displayName
      String defaultName = _emailController.text.split('@').first;
  ...
  Future<void> _registerWithGoogle() async {
    ...
    try {
      ...
      // Create/Update profile with Google name
      final profileData = {
              ...
              child: SlideTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      'Start your pen collection journey',
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                onPressed:
                                    _isGoogleLoading ? null : _registerWithGoogle,
